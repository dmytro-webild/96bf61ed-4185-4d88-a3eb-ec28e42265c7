...
export const metadata: Metadata = {
  title: "24-Hour Website Design Dubai | Nebula Studio",  description: "Professional websites delivered in 24 hours for UAE businesses. Conversion-focused design, fast turnaround. Chat with us on WhatsApp.",  keywords: "website design Dubai, web design UAE, 24 hour website, professional web design, lead conversion, business website",  metadataBase: new URL("https://nebulastudio.ae"),
  alternates: {
    canonical: "https://nebulastudio.ae"},
  openGraph: {
    title: "24-Hour Website Design Dubai | Nebula Studio",    description: "Professional websites delivered in 24 hours. Convert more leads with Nebula Studio.",    url: "https://nebulastudio.ae",    siteName: "Nebula Studio",    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "24-Hour Website Design Dubai | Nebula Studio",    description: "Professional websites delivered in 24 hours for UAE businesses"},
  robots: {
    index: true,
    follow: true,
  },
